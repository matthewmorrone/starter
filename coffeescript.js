...
(function(root) {
    var CoffeeScript = function() {
        ...
        return require["./helpers"] = function() {
                    ...
                    return e.prototype.tokenize = function(e, t) {
                        ...
                        if (e = o.slice(1, -1), a = this.removeNewlines(e), '"' === s && o.indexOf("#{", 1) > 0) {
                            for (n = r = 0, t = e.length; "\n" === e.charAt(r++) && t > r; )
                                n++;
                            this.interpolateString(a, {strOffset: 1 + n,lexedLength: o.length})
                        } else
                            this.token("STRING", s + this.escapeLines(a) + s, 0, o.length);
                        return (i = /^(?:\\.|[^\\])*\\(?:0[0-7]|[1-7])/.test(o)) && this.error("octal escape sequences " + o + " are not allowed"), o.length
                    }, e.prototype.heredocToken = function() {
                        var e, t, n, i, r;
                        return (n = u.exec(this.chunk)) ? (t = n[0], i = t.charAt(0), e = this.sanitizeHeredoc(n[2], {quote: i,indent: null}), '"' === i && e.indexOf("#{") >= 0 ? (r = "\n" === n[2].charAt(0) ? 4 : 3, this.interpolateString(e, {heredoc: !0,strOffset: r,lexedLength: t.length})) : this.token("STRING", this.makeString(e, i, !0), 0, t.length), t.length) : 0
                        ...
                        for (this.token("IDENTIFIER", "RegExp", 0, 0), this.token("CALL_START", "(", 0, 0), l = [], b = this.interpolateString(e, {regex: !0,strOffset: 3}), p = 0, d = b.length; d > p; p++) {
                        ...
                        for (null == n && (n = {}), o = n.heredoc, v = n.regex, b = n.offsetInChunk, T = n.strOffset, p = n.lexedLength, b || (b = 0), T || (T = 0), p || (p = t.length), C = [], g = 0, a = -1; u = t.charAt(a += 1); )
                            "\\" !== u ? "#" === u && "{" === t.charAt(a + 1) && (s = this.balancedString(t.slice(a + 1), "}")) && (a > g && C.push(this.makeToken("NEOSTRING", t.slice(g, a), T + g)), r || (r = this.makeToken("", "string interpolation", b + a + 1, 2)), c = s.slice(1, -1), c.length && (D = this.getLineAndColumnFromChunk(T + a + 2), d = D[0], i = D[1], m = (new e).tokenize(c, {line: d,column: i,rewrite: !1}), y = m.pop(), "TERMINATOR" === (null != (S = m[0]) ? S[0] : void 0) && (y = m.shift()), (l = m.length) && (l > 1 && (m.unshift(this.makeToken("(", "(", T + a + 1, 0)), m.push(this.makeToken(")", ")", T + a + 1 + c.length, 0))), C.push(["TOKENS", m]))), a += s.length, g = a + 1) : a += 1;
            ...
            var e = {}, t = {exports: e};
            return function() {
                var t, n, i, r, s, o, a, c, h, l, u, p, d, f, m, b, g, k, y = {}.hasOwnProperty, v = [].indexOf || function(e) {
                    for (var t = 0, n = this.length; n > t; t++)
                        if (t in this && this[t] === e)
                            return t;
                    return -1
                ...
                if (o = require("fs"), d = require("vm"), u = require("path"), t = require("./lexer").Lexer, l = require("./parser").parser, c = require("./helpers"), n = require("./sourcemap"), e.VERSION = "1.8.0", e.FILE_EXTENSIONS = [".coffee", ".litcoffee", ".coffee.md"], e.helpers = c, f = function(e) {
                    ...
                    for (m = c.merge, o = c.extend, t = o({}, t), t.sourceMap && (f = new n), u = l.parse(h.tokenize(e, t)).compileToFragments(t), s = 0, t.header && (s += 1), t.shiftLine && (s += 1), r = 0, d = "", g = 0, k = u.length; k > g; g++)
                        a = u[g], t.sourceMap && (a.locationData && f.add([a.locationData.first_line, a.locationData.first_column], [s, r], {noReplace: !0}), b = c.count(a.code, "\n"), s += b, b ? r = a.code.length - (a.code.lastIndexOf("\n") + 1) : r += a.code.length), d += a.code;
                    ...
                    if (null == t && (t = {}), e = e.trim()) {
                        if (r = d.Script) {
                            ...
                            if (h.__filename = t.filename || "eval", h.__dirname = u.dirname(h.__filename), h === global && !h.module && !h.require) {
                                ...
                                }, m.filename = h.__filename, g = Object.getOwnPropertyNames(require), p = 0, f = g.length; f > p; p++)
                    ...
                    for (k = this.FILE_EXTENSIONS, b = 0, g = k.length; g > b; b++)
                        r = k[b], null == (m = require.extensions)[r] && (m[r] = function() {
                ...
                e._compileFile = function(e, t) {
                    ...
                    try {
                        n = i(a, {filename: e,sourceMap: t,literate: c.isLiterate(e)})
                    } catch (h) {
                        throw r = h, c.updateSyntaxError(r, a, e)
                    }
                    return n
                }, h = new t, l.lexer = {lex: function() {
                        var e, t;
                    ...
                    if (p[t])
                        return p[t];
                    if (i = null != u ? u.extname(t) : void 0, !(0 > v.call(e.FILE_EXTENSIONS, i)))
